            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="post" onsubmit="return verificarPassword();">
                                <div class="row">
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            <label for="" class="col-auto col-form-label">Nombres</label>
                                            <input type="text" class="form-control" max="" placeholder="Digite su nombre de usuario" name="nombre_de_usuario" maxlength="40" required>
                                        </div>
                                    </div>
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            <label for="" class="col-auto col-form-label">Apellidos</label>
                                            <input type="text" class="form-control" max="" placeholder="Digite sus Apellidos" name="apellidos" maxlength="40" required>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            ...
                                            <input type="text" class="form-control" max="" placeholder="su correo" name="correo" maxlength="40" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            ...
                                            <input type="text" class="form-control" max="" placeholder="Institucion" name="institucion" maxlength="40" required>
                                        </div>
                                    </div>
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            <label for="" class="col-auto col-form-label">usuario</label>
                                            <input type="text" class="form-control" max="" placeholder="Institucion" name="usuario" maxlength="40" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            ...
                                            <input type="password" class="form-control" max="" placeholder="Password" name="password" id="password1" maxlength="40" required>
                                        </div>
                                    </div>
                                    <div class="form-group m-2 col">
                                        <div class="mb-3 row">
                                            <label for="" class="col-auto col-form-label">verificacion password</label>
                                            <input type="password" class="form-control" max="" placeholder="Verifica Password" name="passwordw" id="password2" maxlength="40" required>
                                        </div>
                                    </div>
                                </div>
