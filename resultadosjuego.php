                    ...
                    <div class="cta-inner bg-faded text-center rounded">
                        ...
                        <table class="table list-unstyled list-hours mb-5 text-left mx-auto">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM resultados where id_tema=$id and id_usuario=$usuario";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data["aciertos"] ?></td>
                                        <td><?php echo $data["desaciertos"] ?></td>
                        ...
                        <p class="address mb-5">
                            <em>
                                <a class="btn btn-primary" href="juego.php?id_tema=<?php echo $id ?>">jugar</a>
