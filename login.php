            ...
            <div class="d-flex justify-content-center align-items-center flex-column">
                ...
                <div class="card">
                    <div class="card-header " style="background-color:#D4DBF9;color:#2A5890;">
                        <div class="row">
                            <div class="col">
                                <h6>Bienvenidos</h6> <label>Inicia sesión para ingresar</label>
                            </div>

                            <div class="col row">
                                <div class="col"></div>
                                <div class="col"><img style="width: 100px;height: 100px;" src="assets/img/seguridad3.png"></div>
                            </div>
                        </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group m-2">
                                <div class="mb-3 row">
                                    ...
                                    <input type="text" class="form-control" max="" placeholder="Digite su usuario" name="nombre_de_usuario" maxlength="40" required>
                                </div>
                            </div>
                            <div class="form-group m-2">
                                <div class="mb-3 row">
                                    <label for="" class="col-auto col-form-label">Contraseña</label>
                                    <input type="password" class="form-control" max="" placeholder="Digite su Contraseña" name="password" maxlength="40" required>
                                </div>
