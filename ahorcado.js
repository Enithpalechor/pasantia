...
var palabras = [
  ...
  ["Protocolo", "Medida de protección"],
  ["Riesgo", "amenazas "],
  ...
  [
    "Hakers",
    "es alguien que descubre las vulnerabilidades de una computadora ",
  ],
];
// Palabra a averiguar
var palabra = "";
...
function generaABC(a, z) {
  ...
  for (; i <= j; i++) {
    ...
    if (i == 110) {
      document.getElementById("abcdario").innerHTML +=
        "<button value='Ñ' onclick='intento(\"Ñ\")' class='letra fondoboton' id='" +
        letra +
        "'>Ñ</button>";
    }
  }
...
function guardar() {
  console.log(estado);
  axios
    .post("db/guardarjuego.php?estado=" + estado)
    .then(function (res) {
